namespace VRage
{
    ...
    {
        private const uint DEFAULT_SEED = uint.MaxValue;
        private static readonly uint[] m_crcTable = new uint[] { 
        ...
        {
            this.m_crcValue ^= uint.MaxValue;
            while (--length >= 0)
            {
                start++;
                this.m_crcValue = m_crcTable[((int) (this.m_crcValue ^ buffer[start])) & 0xff] ^ (this.m_crcValue >> 8);
            }
            this.m_crcValue ^= uint.MaxValue;
        }
        ...
        {
            base.HashValue = new byte[] { (byte) ((this.m_crcValue >> 0x18) & 0xff), (byte) ((this.m_crcValue >> 0x10) & 0xff), (byte) ((this.m_crcValue >> 8) & 0xff), (byte) (this.m_crcValue & 0xff) };
        ...
        public uint CrcValue =>
            ((uint) ((((base.HashValue[0] << 0x18) | (base.HashValue[1] << 0x10)) | (base.HashValue[2] << 8)) | base.HashValue[3]));
