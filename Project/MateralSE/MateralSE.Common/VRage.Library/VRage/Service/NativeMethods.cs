namespace VRage.Service
{
    ...
    internal static class NativeMethods
    {
        ...
        {
            SessionChangeDescriptionUnion union;
            union.Desc = new SessionChangeDescription();
            SessionChangeDescriptionCopy copy = new SessionChangeDescriptionCopy {
                _id = id,
                _reason = reason
            };
            union.DescCopy = copy;
        ...
        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Unicode), UnsharperDisableReflection]
        public struct SERVICE_FAILURE_ACTIONS
        {
            ...
            public unsafe VRage.Service.NativeMethods.SC_ACTION* actions;
        }
        ...
        private struct SessionChangeDescriptionUnion
        {
            ...
            [FieldOffset(0)]
            public VRage.Service.NativeMethods.SessionChangeDescriptionCopy DescCopy;
        }
