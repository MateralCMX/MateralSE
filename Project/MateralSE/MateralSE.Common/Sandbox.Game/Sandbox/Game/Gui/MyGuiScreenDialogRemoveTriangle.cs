namespace Sandbox.Game.Gui
{
    ...
    internal class MyGuiScreenDialogRemoveTriangle : MyGuiScreenBase
    {
        ...
        public MyGuiScreenDialogRemoveTriangle() : base(new Vector2(0.5f, 0.5f), new Vector4?(MyGuiConstants.SCREEN_BACKGROUND_COLOR), nullable, false, null, 0f, 0f)
        {
        ...
        public override void RecreateControls(bool contructor)
        {
            ...
            this.Controls.Add(new MyGuiControlLabel(new Vector2(0f, -0.1f), size, "Enter the number of a navmesh triangle to remove", colorMask, 0.8f, "Blue", MyGuiDrawAlignEnum.HORISONTAL_CENTER_AND_VERTICAL_CENTER));
            colorMask = null;
