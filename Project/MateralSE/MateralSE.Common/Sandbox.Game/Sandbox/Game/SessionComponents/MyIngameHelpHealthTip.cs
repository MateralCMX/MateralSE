namespace Sandbox.Game.SessionComponents
{
    ...
    internal class MyIngameHelpHealthTip : MyIngameHelpObjective
    {
        public MyIngameHelpHealthTip()
        {
            ...
            base.RequiredIds = new string[] { "IngameHelp_Health" };
            MyIngameHelpDetail detail1 = new MyIngameHelpDetail();
            detail1.TextEnum = MySpaceTexts.IngameHelp_HealthTip_Detail1;
            ...
            detail2.TextEnum = MySpaceTexts.IngameHelp_HealthTip_Detail2;
