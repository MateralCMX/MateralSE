namespace Sandbox.Game.SessionComponents
{
    ...
    internal class MyIngameHelpMagneticBootsTip : MyIngameHelpObjective
    {
        public MyIngameHelpMagneticBootsTip()
        {
            ...
            base.RequiredIds = new string[] { "IngameHelp_MagneticBoots" };
            MyIngameHelpDetail detail1 = new MyIngameHelpDetail();
            detail1.TextEnum = MySpaceTexts.IngameHelp_MagneticBootsTip_Detail1;
            ...
            detail2.TextEnum = MySpaceTexts.IngameHelp_MagneticBootsTip_Detail2;
