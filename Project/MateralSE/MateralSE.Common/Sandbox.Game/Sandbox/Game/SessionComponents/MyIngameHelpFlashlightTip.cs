namespace Sandbox.Game.SessionComponents
{
    ...
    [IngameObjective("IngameHelp_FlashlightTip", 0x54)]
    internal class MyIngameHelpFlashlightTip : MyIngameHelpObjective
    {
        public MyIngameHelpFlashlightTip()
        {
            ...
            base.RequiredIds = new string[] { "IngameHelp_Flashlight" };
            MyIngameHelpDetail detail1 = new MyIngameHelpDetail();
            detail1.TextEnum = MySpaceTexts.IngameHelp_FlashlightTip_Detail1;
            ...
            detail2.TextEnum = MySpaceTexts.IngameHelp_FlashlightTip_Detail2;
