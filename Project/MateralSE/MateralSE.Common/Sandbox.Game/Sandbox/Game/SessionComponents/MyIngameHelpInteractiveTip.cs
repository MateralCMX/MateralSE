namespace Sandbox.Game.SessionComponents
{
    ...
    [IngameObjective("IngameHelp_InteractiveTip", 0x17)]
    internal class MyIngameHelpInteractiveTip : MyIngameHelpObjective
    {
        public MyIngameHelpInteractiveTip()
        {
            ...
            base.RequiredIds = new string[] { "IngameHelp_Interactive" };
            MyIngameHelpDetail detail1 = new MyIngameHelpDetail();
            detail1.TextEnum = MySpaceTexts.IngameHelp_InteractiveTip_Detail1;
            ...
            detail2.TextEnum = MySpaceTexts.IngameHelp_InteractiveTip_Detail2;
