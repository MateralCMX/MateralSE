namespace Sandbox.Game.SessionComponents
{
    ...
    internal class MyIngameHelpInventoryTip : MyIngameHelpObjective
    {
        public MyIngameHelpInventoryTip()
        {
            ...
            base.RequiredIds = new string[] { "IngameHelp_Inventory" };
            MyIngameHelpDetail detail1 = new MyIngameHelpDetail();
            detail1.TextEnum = MySpaceTexts.IngameHelp_InventoryTip_Detail1;
            ...
            detail2.TextEnum = MySpaceTexts.IngameHelp_InventoryTip_Detail2;
