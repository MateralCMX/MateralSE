namespace Sandbox.Game.SessionComponents
{
    ...
    internal class MyIngameHelpComponentsTip : MyIngameHelpObjective
    {
        public MyIngameHelpComponentsTip()
        {
            ...
            base.RequiredIds = new string[] { "IngameHelp_Components" };
            MyIngameHelpDetail detail1 = new MyIngameHelpDetail();
            detail1.TextEnum = MySpaceTexts.IngameHelp_ComponentsTip_Detail1;
            ...
            detail2.TextEnum = MySpaceTexts.IngameHelp_ComponentsTip_Detail2;
