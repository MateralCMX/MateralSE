namespace Sandbox.Game.Entities.Cube
{
    ...
    public class MyUseObjectAirtightDoors : MyUseObjectBase
    {
        ...
        public MyUseObjectAirtightDoors(IMyEntity owner, string dummyName, MyModelDummy dummyData, uint key) : base(owner, dummyData)
        {
            this.Door = (MyAirtightDoorGeneric) owner;
        ...
        public override void Use(UseActionEnum actionEnum, IMyEntity entity)
        {
            ...
            if (!this.Door.GetUserRelationToOwner(controllingIdentityId).IsFriendly() && !MySession.Static.AdminSettings.HasFlag(AdminSettingsEnum.UseTerminals))
            {
            ...
            {
                this.Door.SetOpenRequest(!this.Door.Open, controllingIdentityId);
            }
