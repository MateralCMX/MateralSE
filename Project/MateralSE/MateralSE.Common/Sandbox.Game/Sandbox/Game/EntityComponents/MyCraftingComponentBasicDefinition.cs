namespace Sandbox.Game.EntityComponents
{
    ...
    [MyDefinitionType(typeof(MyObjectBuilder_CraftingComponentBasicDefinition), (Type) null)]
    public class MyCraftingComponentBasicDefinition : MyComponentDefinitionBase
    {
        ...
        {
            base.Init(builder);
            MyObjectBuilder_CraftingComponentBasicDefinition definition = builder as MyObjectBuilder_CraftingComponentBasicDefinition;
