namespace Sandbox.Engine.Utils
{
    ...
    public static class MySpaceBindingCreator
    {
        ...
        {
            MyControllerHelper.AddContext(CX_BUILD_MODE, new MyStringId?(CX_CHARACTER));
            ...
            MyControllerHelper.AddControl(CX_BUILD_MODE, MyControlsSpace.BUILD_MODE, MyJoystickButtonsEnum.J09);
        }

        private static void CreateForCharacter()
        {
            MyControllerHelper.AddContext(CX_CHARACTER, new MyStringId?(CX_BASE));
            ...
            MyControllerHelper.AddControl(CX_CHARACTER, MyControlsSpace.PRIMARY_BUILD_ACTION, MyJoystickAxesEnum.Zneg);
            MyControllerHelper.AddControl(CX_CHARACTER, MyControlsSpace.SECONDARY_BUILD_ACTION, MyJoystickAxesEnum.Zpos);
            MyControllerHelper.AddControl(CX_CHARACTER, MyControlsSpace.COPY_PASTE_ACTION, MyJoystickAxesEnum.Zneg);
            ...
            MyControllerHelper.AddControl(CX_CHARACTER, MyControlsSpace.BUILD_MODE, MyJoystickButtonsEnum.J09);
        }

        private static void CreateForGUI()
        {
            MyControllerHelper.AddContext(CX_GUI, new MyStringId?(CX_BASE));
        ...
        {
            MyControllerHelper.AddContext(CX_SPACESHIP, new MyStringId?(CX_CHARACTER));
        ...
        {
            MyControllerHelper.AddContext(CX_VOXEL, new MyStringId?(CX_CHARACTER));
