namespace VRage.Game
{
    ...
    public struct ColorDefinitionHSV
    {
        ...
        public static unsafe implicit operator Vector3(ColorDefinitionHSV definition)
        {
            int* numPtr1 = (int*) ref definition.H;
            numPtr1[0] = numPtr1[0] % 360;
            if (definition.H < 0)
            {
                int* numPtr2 = (int*) ref definition.H;
                numPtr2[0] += 360;
            }
