namespace VRage.Game.ModAPI.Ingame.Utilities
{
    ...
    public struct MyIniKey : IEquatable<MyIniKey>
    {
        ...
        internal static string ValidateSection(ref StringSegment segment) => 
            ((segment.Length != 0) ? ((segment.IndexOfAny(INVALID_KEY_CHARS) < 0) ? null : $"contains illegal characters ({INVALID_KEY_CHARS_STR})") : "cannot be empty.");
        ...
        public bool Equals(MyIniKey other)
        {
            ...
            return this.NameSegment.EqualsIgnoreCase(other.NameSegment);
        }

        public override bool Equals(object obj) => 
            ((obj != null) ? ((obj is MyIniKey) && this.Equals((MyIniKey) obj)) : false);
        ...
        public override string ToString() => 
            (!this.IsEmpty ? $"{this.Section}/{this.Name}" : "");
