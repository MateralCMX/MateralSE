namespace VRage.Game
{
    ...
    public static class MyConstants
    {
        ...
        public static readonly float FIELD_OF_VIEW_CONFIG_MAX = MathHelper.ToRadians((float) 120f);
        public static readonly float FIELD_OF_VIEW_CONFIG_MAX_SAFE = MathHelper.ToRadians((float) 120f);
