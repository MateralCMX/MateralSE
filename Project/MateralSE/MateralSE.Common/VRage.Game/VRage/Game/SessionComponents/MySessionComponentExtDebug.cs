namespace VRage.Game.SessionComponents
{
    ...
    public class MySessionComponentExtDebug : MySessionComponentBase
    {
        ...
        private void ServerListenerProc()
        {
            ...
            try
            {
                TcpListener listener1 = new TcpListener(IPAddress.Loopback, 0x32c8);
                listener1.ExclusiveAddressUse = false;
                this.m_listener = listener1;
            ...
            while (true)
            {
                try
                {
                    ...
                    entity.TcpClient = client;
                    entity.LastHeader = MyExternalDebugStructures.CommonMsgHeader.Create("UNKNOWN", 0);
        ...
        private bool StartServer()
        {
            ...
            Thread thread1 = new Thread(new ThreadStart(this.ServerListenerProc));
            thread1.IsBackground = true;
            this.m_listenerThread = thread1;
        ...
        public override void UpdateBeforeSimulation()
        {
            foreach (MyDebugClientInfo info in this.m_clients)
            {
                ...
                if (info.TcpClient.Connected && (info.TcpClient.Available > 0))
                {
