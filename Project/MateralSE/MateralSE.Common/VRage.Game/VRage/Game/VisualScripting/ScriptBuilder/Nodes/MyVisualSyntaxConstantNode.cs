namespace VRage.Game.VisualScripting.ScriptBuilder.Nodes
{
    ...
    public class MyVisualSyntaxConstantNode : MyVisualSyntaxNode
    {
        ...
        internal override void CollectInputExpressions(List<StatementSyntax> expressions)
        {
            ...
            {
                expressions.Add(MySyntaxFactory.LocalVariable(this.ObjectBuilder.Type, this.VariableSyntaxName(null), MySyntaxFactory.NewVector3D(this.ObjectBuilder.Vector)));
            }
            else
            {
