namespace VRageMath
{
    ...
    public struct Vector4D : IEquatable<Vector4>
    {
        ...
        public static unsafe Vector4 Min(Vector4 value1, Vector4 value2)
        {
            Vector4 vector;
            Vector4* vectorPtr1;
            Vector4* vectorPtr2;
            ...
            vectorPtr1 = (Vector4*) ref vector;
            vectorPtr2->Y = (value1.Y < value2.Y) ? value1.Y : value2.Y;
            vectorPtr2 = (Vector4*) ref vector;
            vectorPtr3->Z = (value1.Z < value2.Z) ? value1.Z : value2.Z;
            vectorPtr3 = (Vector4*) ref vector;
            vectorPtr4->W = (value1.W < value2.W) ? value1.W : value2.W;
            vectorPtr4 = (Vector4*) ref vector;
            return vector;
        }
        ...
        public static unsafe Vector4 Max(Vector4 value1, Vector4 value2)
        {
            Vector4 vector;
            Vector4* vectorPtr1;
            Vector4* vectorPtr2;
        ...
        public static Vector4D Clamp(Vector4D value1, Vector4D min, Vector4D max)
        {
            ...
            vectord.Y = num6;
            vectord.Z = num9;
            vectord.W = (num11 < min.W) ? min.W : num11;
            return vectord;
        }
        ...
        public static Vector4D SmoothStep(Vector4D value1, Vector4D value2, double amount)
        {
            Vector4D vectord;
            double num1 = amount;
            amount = (amount > 1.0) ? 1.0 : ((amount < 0.0) ? 0.0 : num1);
        ...
        {
            Vector4D vectord;
            vectord.X = ((position.X * matrix.M11) + (position.Y * matrix.M21)) + matrix.M41;
            vectord.Y = ((position.X * matrix.M12) + (position.Y * matrix.M22)) + matrix.M42;
            vectord.Z = ((position.X * matrix.M13) + (position.Y * matrix.M23)) + matrix.M43;
            vectord.W = ((position.X * matrix.M14) + (position.Y * matrix.M24)) + matrix.M44;
            return vectord;
        }
        ...
        {
            Vector4D vectord;
            vectord.X = (((position.X * matrix.M11) + (position.Y * matrix.M21)) + (position.Z * matrix.M31)) + matrix.M41;
            vectord.Y = (((position.X * matrix.M12) + (position.Y * matrix.M22)) + (position.Z * matrix.M32)) + matrix.M42;
            vectord.Z = (((position.X * matrix.M13) + (position.Y * matrix.M23)) + (position.Z * matrix.M33)) + matrix.M43;
            vectord.W = (((position.X * matrix.M14) + (position.Y * matrix.M24)) + (position.Z * matrix.M34)) + matrix.M44;
            return vectord;
        }
        ...
        {
            Vector4D vectord;
            vectord.X = (((vector.X * matrix.M11) + (vector.Y * matrix.M21)) + (vector.Z * matrix.M31)) + (vector.W * matrix.M41);
            vectord.Y = (((vector.X * matrix.M12) + (vector.Y * matrix.M22)) + (vector.Z * matrix.M32)) + (vector.W * matrix.M42);
            vectord.Z = (((vector.X * matrix.M13) + (vector.Y * matrix.M23)) + (vector.Z * matrix.M33)) + (vector.W * matrix.M43);
            vectord.W = (((vector.X * matrix.M14) + (vector.Y * matrix.M24)) + (vector.Z * matrix.M34)) + (vector.W * matrix.M44);
            return vectord;
        }
        ...
        public static Vector4D Transform(Vector2 value, Quaternion rotation)
        {
            ...
            vectord.X = (value.X * ((1.0 - num10) - num12)) + (value.Y * (num8 - num6));
            vectord.Y = (value.X * (num8 + num6)) + (value.Y * ((1.0 - num7) - num12));
            vectord.Z = (value.X * (num9 - num5)) + (value.Y * (num11 + num4));
            vectord.W = 1.0;
            return vectord;
        }
        ...
        public static Vector4D Transform(Vector3D value, Quaternion rotation)
        {
            ...
            double num11 = rotation.Y * num3;
            double num12 = rotation.Z * num3;
            vectord.X = ((value.X * ((1.0 - num10) - num12)) + (value.Y * (num8 - num6))) + (value.Z * (num9 + num5));
            vectord.Y = ((value.X * (num8 + num6)) + (value.Y * ((1.0 - num7) - num12))) + (value.Z * (num11 - num4));
            vectord.Z = ((value.X * (num9 - num5)) + (value.Y * (num11 + num4))) + (value.Z * ((1.0 - num7) - num10));
            vectord.W = 1.0;
            return vectord;
        }
