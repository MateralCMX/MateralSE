namespace VRageMath
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        public override bool Equals(object obj) => 
            ((obj != null) ? (!(obj.GetType() != typeof(RectangleF)) ? this.Equals((RectangleF) obj) : false) : false);

        public override int GetHashCode() => 
            ((((((this.X.GetHashCode() * 0x18d) ^ this.Y.GetHashCode()) * 0x18d) ^ this.Width.GetHashCode()) * 0x18d) ^ this.Height.GetHashCode());
