namespace VRageMath
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        public static Vector4 Clamp(Vector4 value1, Vector4 min, Vector4 max)
        {
            ...
            vector.Y = num6;
            vector.Z = num9;
            vector.W = (num11 < min.W) ? min.W : num11;
            return vector;
        }
        ...
        public static Vector4 Transform(Vector2 position, Matrix matrix)
        {
            ...
            vector.Z = ((position.X * matrix.M13) + (position.Y * matrix.M23)) + matrix.M43;
            vector.W = ((position.X * matrix.M14) + (position.Y * matrix.M24)) + matrix.M44;
            return vector;
        }
        ...
        public static Vector4 Transform(Vector3 position, Matrix matrix)
        {
            ...
            vector.W = (((position.X * matrix.M14) + (position.Y * matrix.M24)) + (position.Z * matrix.M34)) + matrix.M44;
            return vector;
        }
        ...
        {
            Vector4 vector2;
            vector2.X = (((vector.X * matrix.M11) + (vector.Y * matrix.M21)) + (vector.Z * matrix.M31)) + (vector.W * matrix.M41);
            vector2.Y = (((vector.X * matrix.M12) + (vector.Y * matrix.M22)) + (vector.Z * matrix.M32)) + (vector.W * matrix.M42);
            vector2.Z = (((vector.X * matrix.M13) + (vector.Y * matrix.M23)) + (vector.Z * matrix.M33)) + (vector.W * matrix.M43);
            vector2.W = (((vector.X * matrix.M14) + (vector.Y * matrix.M24)) + (vector.Z * matrix.M34)) + (vector.W * matrix.M44);
            return vector2;
        }
        ...
        public static Vector4 Transform(Vector2 value, Quaternion rotation)
        {
            ...
            vector.X = ((float) (value.X * ((1.0 - num10) - num12))) + (value.Y * (num8 - num6));
            vector.Y = (value.X * (num8 + num6)) + ((float) (value.Y * ((1.0 - num7) - num12)));
            vector.Z = (value.X * (num9 - num5)) + (value.Y * (num11 + num4));
            vector.W = 1f;
            return vector;
        }
