namespace VRageMath
{
    ...
    public struct Ray : IEquatable<Ray>
    {
        ...
        {
            object[] args = new object[] { this.Position.ToString(), this.Direction.ToString() };
            return string.Format(CultureInfo.CurrentCulture, "{{Position:{0} Direction:{1}}}", args);
        }
        ...
        public float? Intersects(BoundingSphere sphere)
        {
            ...
            if (num6 >= 0.0)
            {
                ...
                if (num7 <= num5)
                {
                    return new float?(num6 - ((float) Math.Sqrt(num5 - num7)));
                }
            }
            return null;
        }
        ...
        public void Intersects(ref BoundingSphere sphere, out float? result)
        {
            ...
            else
            {
                ...
                if (num6 >= 0.0)
                {
                    ...
                    if (num7 <= num5)
                    {
                        result = new float?(num6 - ((float) Math.Sqrt(num5 - num7)));
                    }
                }
            }
        }
