namespace VRageMath
{
    ...
    public struct QuaternionD
    {
        ...
        public unsafe void GetAxisAngle(out Vector3D axis, out double angle)
        {
            axis.X = this.X;
            axis.Y = this.Y;
            axis.Z = this.Z;
            ...
            if (y != 0.0)
            {
                double* numPtr1 = (double*) ref axis.X;
                numPtr1[0] /= y;
                double* numPtr2 = (double*) ref axis.Y;
                numPtr2[0] /= y;
                double* numPtr3 = (double*) ref axis.Z;
                numPtr3[0] /= y;
            }
        ...
        public static QuaternionD CreateFromYawPitchRoll(double yaw, double pitch, double roll)
        {
            ...
            double num = Math.Sin(a);
            double num2 = Math.Cos(a);
            double num7 = pitch * 0.5;
            double num3 = Math.Sin(num7);
            double num4 = Math.Cos(num7);
            double num8 = yaw * 0.5;
            double num5 = Math.Sin(num8);
            double num6 = Math.Cos(num8);
            nd.X = ((num6 * num3) * num2) + ((num5 * num4) * num);
            nd.Y = ((num5 * num4) * num2) - ((num6 * num3) * num);
            nd.Z = ((num6 * num4) * num) - ((num5 * num3) * num2);
            nd.W = ((num6 * num4) * num2) + ((num5 * num3) * num);
            return nd;
        }
        ...
        public static QuaternionD CreateFromForwardUp(Vector3D forward, Vector3D up)
        {
            ...
            double y = vectord2.Y;
            double z = vectord2.Z;
            Vector3D vectord1 = Vector3D.Cross(vectord, vectord2);
            double num4 = vectord1.X;
            double num5 = vectord1.Y;
            double num6 = vectord1.Z;
            ...
            if (num10 > 0.0)
            {
                double num13 = Math.Sqrt(num10 + 1.0);
                nd.W = num13 * 0.5;
                num13 = 0.5 / num13;
                nd.X = (num6 - num8) * num13;
                nd.Y = (num7 - z) * num13;
                nd.Z = (y - num4) * num13;
                return nd;
            }
            if ((x >= num5) && (x >= num9))
            {
                double num14 = Math.Sqrt(((1.0 + x) - num5) - num9);
                double num15 = 0.5 / num14;
                nd.X = 0.5 * num14;
                nd.Y = (y + num4) * num15;
                nd.Z = (z + num7) * num15;
                nd.W = (num6 - num8) * num15;
                return nd;
            }
            if (num5 > num9)
            {
                double num16 = Math.Sqrt(((1.0 + num5) - x) - num9);
                double num17 = 0.5 / num16;
                nd.X = (num4 + y) * num17;
                nd.Y = 0.5 * num16;
                nd.Z = (num8 + num6) * num17;
                nd.W = (num7 - z) * num17;
                return nd;
            }
            double num11 = Math.Sqrt(((1.0 + num9) - x) - num5);
            double num12 = 0.5 / num11;
            nd.X = (num7 + z) * num12;
            nd.Y = (num8 + num6) * num12;
            nd.Z = 0.5 * num11;
            nd.W = (y - num4) * num12;
            return nd;
        }
        ...
        public static unsafe QuaternionD Lerp(QuaternionD quaternion1, QuaternionD quaternion2, double amount)
        {
            double num = amount;
            double num2 = 1.0 - num;
            QuaternionD nd = new QuaternionD();
            ...
            double* numPtr1 = (double*) ref nd.X;
            numPtr1[0] *= num3;
            double* numPtr2 = (double*) ref nd.Y;
            numPtr2[0] *= num3;
            double* numPtr3 = (double*) ref nd.Z;
            numPtr3[0] *= num3;
            double* numPtr4 = (double*) ref nd.W;
            numPtr4[0] *= num3;
            return nd;
        }

        public static unsafe void Lerp(ref QuaternionD quaternion1, ref QuaternionD quaternion2, double amount, out QuaternionD result)
        {
            double num = amount;
            double num2 = 1.0 - num;
            if (((((quaternion1.X * quaternion2.X) + (quaternion1.Y * quaternion2.Y)) + (quaternion1.Z * quaternion2.Z)) + (quaternion1.W * quaternion2.W)) >= 0.0)
            ...
            double* numPtr1 = (double*) ref result.X;
            numPtr1[0] *= num3;
            double* numPtr2 = (double*) ref result.Y;
            numPtr2[0] *= num3;
            double* numPtr3 = (double*) ref result.Z;
            numPtr3[0] *= num3;
            double* numPtr4 = (double*) ref result.W;
            numPtr4[0] *= num3;
        }
        ...
        public static unsafe void CreateFromTwoVectors(ref Vector3D firstVector, ref Vector3D secondVector, out QuaternionD result)
        {
            Vector3D vectord;
            Vector3D.Cross(ref firstVector, ref secondVector, out vectord);
            result = new QuaternionD(vectord.X, vectord.Y, vectord.Z, Vector3D.Dot(firstVector, secondVector));
            double* numPtr1 = (double*) ref result.W;
            numPtr1[0] += result.Length();
            result.Normalize();
        }
