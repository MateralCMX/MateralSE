namespace VRageMath
{
    ...
    public struct BoundingBox2I : IEquatable<BoundingBox2I>
    {
        ...
        public static unsafe BoundingBox2I CreateFromPoints(IEnumerable<Vector2I> points)
        {
            if (points == null)
            {
            ...
            bool flag = false;
            Vector2I min = new Vector2I(0x7fffffff);
            Vector2I max = new Vector2I(-2147483648);
            foreach (Vector2I vectori3 in points)
            {
                Vector2I* vectoriPtr1 = (Vector2I*) ref min;
                Vector2I.Min(ref (Vector2I) ref vectoriPtr1, ref vectori3, out min);
                Vector2I* vectoriPtr2 = (Vector2I*) ref max;
                Vector2I.Max(ref (Vector2I) ref vectoriPtr2, ref vectori3, out max);
                flag = true;
            }
            if (!flag)
            {
        ...
        public unsafe float Perimeter()
        {
            ...
            Vector2I* vectoriPtr1 = (Vector2I*) ref vectori;
            vectoriPtr1->X = num = vectori.Y;
            return (float) (2 * num);
        }
        ...
        public unsafe void Scale(Vector2I scale)
        {
            Vector2I center = this.Center;
            Vector2I halfExtents = this.HalfExtents;
            int* numPtr1 = (int*) ref halfExtents.X;
            numPtr1[0] *= scale.X;
            int* numPtr2 = (int*) ref halfExtents.Y;
            numPtr2[0] *= scale.Y;
