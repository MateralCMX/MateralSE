namespace VRageMath
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public override string ToString()
        {
            ...
            object[] args = new object[] { this.X.ToString(currentCulture), this.Y.ToString(currentCulture), this.Z.ToString(currentCulture), this.W.ToString(currentCulture) };
            return string.Format(currentCulture, "{{X:{0} Y:{1} Z:{2} W:{3}}}", args);
        }

        public string ToString(string format)
        {
            CultureInfo currentCulture = CultureInfo.CurrentCulture;
            object[] args = new object[] { this.X.ToString(format, currentCulture), this.Y.ToString(format, currentCulture), this.Z.ToString(format, currentCulture), this.W.ToString(format, currentCulture) };
            return string.Format(currentCulture, "{{X:{0} Y:{1} Z:{2} W:{3}}}", args);
        }
        ...
        public unsafe void GetAxisAngle(out Vector3 axis, out float angle)
        {
            axis.X = this.X;
            axis.Y = this.Y;
            axis.Z = this.Z;
            ...
            if (num != 0f)
            {
                float* singlePtr1 = (float*) ref axis.X;
                singlePtr1[0] /= num;
                float* singlePtr2 = (float*) ref axis.Y;
                singlePtr2[0] /= num;
                float* singlePtr3 = (float*) ref axis.Z;
                singlePtr3[0] /= num;
            }
        ...
        public static Quaternion CreateFromForwardUp(Vector3 forward, Vector3 up)
        {
            ...
            float y = vector2.Y;
            float z = vector2.Z;
            Vector3 vector1 = Vector3.Cross(vector, vector2);
            float num4 = vector1.X;
            float num5 = vector1.Y;
            float num6 = vector1.Z;
            float num7 = vector.X;
            float num8 = vector.Y;
            float num9 = vector.Z;
            ...
            if (num10 > 0f)
            {
                float num13 = (float) Math.Sqrt((double) (num10 + 1f));
                quaternion.W = num13 * 0.5f;
                num13 = 0.5f / num13;
                quaternion.X = (num6 - num8) * num13;
                quaternion.Y = (num7 - z) * num13;
                quaternion.Z = (y - num4) * num13;
                return quaternion;
            }
            if ((x >= num5) && (x >= num9))
            {
                float num14 = (float) Math.Sqrt((double) (((1f + x) - num5) - num9));
                float num15 = 0.5f / num14;
                quaternion.X = 0.5f * num14;
                quaternion.Y = (y + num4) * num15;
                quaternion.Z = (z + num7) * num15;
                quaternion.W = (num6 - num8) * num15;
                return quaternion;
            }
            if (num5 > num9)
            {
                float num16 = (float) Math.Sqrt((double) (((1f + num5) - x) - num9));
                float num17 = 0.5f / num16;
                quaternion.X = (num4 + y) * num17;
                quaternion.Y = 0.5f * num16;
                quaternion.Z = (num8 + num6) * num17;
                quaternion.W = (num7 - z) * num17;
                return quaternion;
            }
            float num11 = (float) Math.Sqrt((double) (((1f + num9) - x) - num5));
            float num12 = 0.5f / num11;
            quaternion.X = (num7 + z) * num12;
            quaternion.Y = (num8 + num6) * num12;
            quaternion.Z = 0.5f * num11;
            quaternion.W = (y - num4) * num12;
            return quaternion;
        }
        ...
        {
            CreateFromRotationMatrix(ref (Matrix) ref matrix, out result);
        }

        public static unsafe void CreateFromTwoVectors(ref Vector3 firstVector, ref Vector3 secondVector, out Quaternion result)
        {
            Vector3 vector;
            ...
            float* singlePtr1 = (float*) ref result.W;
            singlePtr1[0] += result.Length();
            result.Normalize();
        }
        ...
        public static unsafe Quaternion Lerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
        {
            float num = amount;
            float num2 = 1f - num;
            Quaternion quaternion = new Quaternion();
            ...
            float* singlePtr1 = (float*) ref quaternion.X;
            singlePtr1[0] *= num3;
            float* singlePtr2 = (float*) ref quaternion.Y;
            singlePtr2[0] *= num3;
            float* singlePtr3 = (float*) ref quaternion.Z;
            singlePtr3[0] *= num3;
            float* singlePtr4 = (float*) ref quaternion.W;
            singlePtr4[0] *= num3;
            return quaternion;
        }

        public static unsafe void Lerp(ref Quaternion quaternion1, ref Quaternion quaternion2, float amount, out Quaternion result)
        {
            float num = amount;
            float num2 = 1f - num;
            if (((((quaternion1.X * quaternion2.X) + (quaternion1.Y * quaternion2.Y)) + (quaternion1.Z * quaternion2.Z)) + (quaternion1.W * quaternion2.W)) >= 0.0)
            ...
            float* singlePtr1 = (float*) ref result.X;
            singlePtr1[0] *= num3;
            float* singlePtr2 = (float*) ref result.Y;
            singlePtr2[0] *= num3;
            float* singlePtr3 = (float*) ref result.Z;
            singlePtr3[0] *= num3;
            float* singlePtr4 = (float*) ref result.W;
            singlePtr4[0] *= num3;
        }
        ...
        public static void GetForward(ref Quaternion q, out Vector3 result)
        {
            ...
            float num7 = q.X * num3;
            result.X = -num7 - num5;
            result.Y = num4 - (q.Y * num3);
            result.Z = (num6 + (q.Y * num2)) - 1f;
        }
        ...
        public static void GetRight(ref Quaternion q, out Vector3 result)
        {
            ...
            result.Y = num5 + (q.W * num2);
            result.Z = num6 - (q.W * num);
        }
        ...
        public static void GetUp(ref Quaternion q, out Vector3 result)
        {
            ...
            float num8 = q.Y * num3;
            float num9 = q.Z * num3;
            result.X = num7 - (q.W * num3);
            result.Y = (1f - num6) - num9;
            result.Z = num8 + (q.W * num);
        }
