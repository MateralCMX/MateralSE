namespace VRageMath
{
    ...
    public struct Color : IPackedVector<uint>, IPackedVector, IEquatable<Color>
    {
        ...
        public Color(int r, int g, int b, int a)
        {
            if (((((r | g) | b) | a) & -256) != 0)
            {
                int num1 = ClampToByte32(r);
                r = num1;
                int num2 = ClampToByte32(g);
                g = num2;
                int num3 = ClampToByte32(b);
                b = num3;
                int num4 = ClampToByte32(a);
                a = num4;
            }
            g = g << 8;
            b = b << 0x10;
        ...
        public static Color operator *(Color value, float scale)
        {
            uint num5;
            Color color;
            uint packedValue = (byte) value.PackedValue;
            uint num2 = (byte) (value.PackedValue >> 8);
            uint num3 = (byte) (value.PackedValue >> 0x10);
            scale *= 65536f;
            uint num4 = (scale >= 0.0) ? ((scale <= 16777215.0) ? ((uint) scale) : 0xffffff) : 0;
            uint num6 = (num2 * num4) >> 0x10;
            uint num7 = (num3 * num4) >> 0x10;
            uint num8 = (((byte) (value.PackedValue >> 0x18)) * num4) >> 0x10;
            if (((packedValue * num4) >> 0x10) > 0xff)
            {
                num5 = 0xff;
            }
            if (num6 > 0xff)
            ...
            color.PackedValue = ((num5 | (num6 << 8)) | (num7 << 0x10)) | (num8 << 0x18);
            return color;
        }
        ...
        private static int ClampToByte32(int value) => 
            ((value >= 0) ? ((value <= 0xff) ? value : 0xff) : 0);

        private static int ClampToByte64(long value) => 
            ((value >= 0L) ? ((value <= 0xffL) ? ((int) value) : 0xff) : 0);
        ...
        {
            Color color;
            uint packedValue = value2.PackedValue;
            int num2 = (byte) value1.PackedValue;
            int num3 = (byte) (value1.PackedValue >> 8);
            int num4 = (byte) (value1.PackedValue >> 0x10);
            int num5 = (byte) (value1.PackedValue >> 0x18);
            int num10 = (int) PackUtils.PackUNorm(65536f, amount);
            int num13 = num4 + (((((byte) (packedValue >> 0x10)) - num4) * num10) >> 0x10);
            int num14 = num5 + (((((byte) (packedValue >> 0x18)) - num5) * num10) >> 0x10);
            color.PackedValue = (uint) ((((num2 + (((((byte) packedValue) - num2) * num10) >> 0x10)) | ((num3 + (((((byte) (packedValue >> 8)) - num3) * num10) >> 0x10)) << 8)) | (num13 << 0x10)) | (num14 << 0x18));
            return color;
        }
        ...
        public override string ToString()
        {
            ...
            return string.Format(CultureInfo.CurrentCulture, "{{R:{0} G:{1} B:{2} A:{3}}}", args);
        }
        ...
        public unsafe Color ToGray()
        {
            ...
            return new Color(((0.2989f * vector.X) + (0.587f * vector.Y)) + (0.114f * vector.Z), ((0.2989f * vector.X) + (0.587f * vector.Y)) + (0.114f * vector.Z), ((0.2989f * vector.X) + (0.587f * vector.Y)) + (0.114f * vector.Z), vector.W);
        }
    }
}
