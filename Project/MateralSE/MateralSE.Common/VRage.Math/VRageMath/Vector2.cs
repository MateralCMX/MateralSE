namespace VRageMath
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        static Vector2()
        {
            ...
            PositiveInfinity = One * (float) 1.0 / (float) 0.0;
        }
        ...
        public static unsafe Vector2 Min(Vector2 value1, Vector2 value2)
        {
            Vector2 vector;
            Vector2* vectorPtr1;
            Vector2* vectorPtr2;
        ...
        public static unsafe Vector2 Max(Vector2 value1, Vector2 value2)
        {
            Vector2 vector;
            Vector2* vectorPtr1;
            Vector2* vectorPtr2;
        ...
        public static Vector2 Clamp(Vector2 value1, Vector2 min, Vector2 max)
        {
            ...
            vector.X = num3;
            vector.Y = (num5 < min.Y) ? min.Y : num5;
            return vector;
        }
        ...
        {
            Vector2 vector;
            vector.X = (normal.X * matrix.M11) + (normal.Y * matrix.M21);
            vector.Y = (normal.X * matrix.M12) + (normal.Y * matrix.M22);
            return vector;
        }
        ...
        public static Vector2 Transform(Vector2 value, Quaternion rotation)
        {
            ...
            vector.X = ((float) (value.X * ((1.0 - num7) - num8))) + (value.Y * (num6 - num4));
            vector.Y = (value.X * (num6 + num4)) + ((float) (value.Y * ((1.0 - num5) - num8)));
            return vector;
        }
        ...
        public static void Transform(Vector2[] sourceArray, ref Quaternion rotation, Vector2[] destinationArray)
        {
            ...
            float num8 = (1f - (rotation.Y * num2)) - num7;
            float single1 = rotation.X * num2;
            float num9 = single1 - num4;
            float num10 = single1 + num4;
            float num11 = (1f - (rotation.X * num)) - num7;
            for (int i = 0; i < sourceArray.Length; i++)
            {
                float x = sourceArray[i].X;
                float y = sourceArray[i].Y;
