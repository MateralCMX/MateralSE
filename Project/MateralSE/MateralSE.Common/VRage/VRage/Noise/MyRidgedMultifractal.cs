namespace VRage.Noise
{
    ...
    public class MyRidgedMultifractal : MyModule
    {
        ...
        public MyRidgedMultifractal(MyNoiseQuality quality = 1, int layerCount = 6, int seed = 0, double frequency = 1.0, double gain = 2.0, double lacunarity = 2.0, double offset = 1.0)
        {
        ...
        public override double GetValue(double x)
        {
            ...
            {
                long num4 = (this.Seed + i) & 0x7fffffff;
                num2 = Math.Abs(base.GradCoherentNoise(x, (int) num4, this.Quality));
        ...
        public override double GetValue(double x, double y)
        {
            ...
            {
                long num4 = (this.Seed + i) & 0x7fffffff;
                num2 = Math.Abs(base.GradCoherentNoise(x, y, (int) num4, this.Quality));
                num2 = this.Offset - num2;
                num2 = (num2 * num2) * num3;
                num3 = MathHelper.Saturate((double) (num2 * this.Gain));
                num += num2 * this.m_spectralWeights[i];
        ...
        public override double GetValue(double x, double y, double z)
        {
            ...
            {
                long num4 = (this.Seed + i) & 0x7fffffff;
                num2 = Math.Abs(base.GradCoherentNoise(x, y, z, (int) num4, this.Quality));
                num2 = this.Offset - num2;
                num2 = (num2 * num2) * num3;
                num3 = MathHelper.Saturate((double) (num2 * this.Gain));
                num += num2 * this.m_spectralWeights[i];
